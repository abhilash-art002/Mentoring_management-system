...
@Component({
  selector: 'app-student-course-selector',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './student-course-selector.component.html',
  styleUrl: './student-course-selector.component.css'
})
export class StudentCourseSelectorComponent implements OnInit {
  studentId = 0;
  courses: any[] = [];
